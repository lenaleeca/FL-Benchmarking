### Run this script in the terminal by:
## Navigate to the .venv directory of your project, then run:
# python "path to this script"
# Example:
# python "C:\Users\April\OneDrive - University of Calgary\April_DrLi_Sepsis_Projects\FL_manuscript_2026\Sepsis\Python\run_mlp_fedprox_posthoc.py"
"""
Run the Sepsis MLP FedProx analysis using the shared FL analysis executor.

This condition-specific script supplies Sepsis paths and analysis settings to
``functions.executor.run_analysis()``. With ``model_family="mlp"`` and
``algorithm_name="tabnn_fedprox"``, the executor uses the MLP-specific
...
Navigate to the .venv directory of your project, then run in the terminal by:
    python "path to this script"
    Example:python "C:\\path\\to\\run_mlp_fedprox_analysis.py"
"""
import sys
import pandas as pd
...
out = run_analysis(
    ...
    fl_site_results_dirs={
        "1": FL_RESULTS_ROOT / "mlp_fedprox" / "site-aa68-01_tabnn_fedprox_20260528_194631",
        "2": FL_RESULTS_ROOT / "mlp_fedprox" / "site-aa68-02_tabnn_fedprox_20260528_194630",
        "3": FL_RESULTS_ROOT / "mlp_fedprox" / "site-aa68-03_tabnn_fedprox_20260528_194631",
        "4": FL_RESULTS_ROOT / "mlp_fedprox" / "site-aa68-04_tabnn_fedprox_20260528_194630",
    },

    server_results_dir=FL_RESULTS_ROOT / "mlp_fedprox" / "server_run_tabnn_fedprox_20260528_194630",

    
    central_results_dir=FL_RESULTS_ROOT / "mlp_central" / "site-aa68-07_tabnn_fedavg_20260529_195857",

    local_results_dirs={
        "1": FL_RESULTS_ROOT / "mlp_local" / "site_1" / "site-aa68-01_tabnn_fedavg_20260529_230147",
        "2": FL_RESULTS_ROOT / "mlp_local" / "site_2" / "site-aa68-02_tabnn_fedavg_20260529_231449",
        "3": FL_RESULTS_ROOT / "mlp_local" / "site_3" / "site-aa68-03_tabnn_fedavg_20260529_232200",
        "4": FL_RESULTS_ROOT / "mlp_local" / "site_4" / "site-aa68-04_tabnn_fedavg_20260529_224953",
    },
