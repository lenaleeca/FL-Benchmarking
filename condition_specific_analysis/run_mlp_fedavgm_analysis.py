"""
Run the Sepsis MLP FedAvg analysis using the shared FL analysis executor.
...
``algorithm_name="tabnn_fedavgm"``, the executor uses the MLP-specific
...
Navigate to the .venv directory of your project, then run in the terminal by:
    ...
    Example:python "C:\\path\\to\\run_mlp_fedavgm_analysis.py"
"""
import sys
import pandas as pd
...
out = run_analysis(
    ...
    fl_site_results_dirs={
        "1": FL_RESULTS_ROOT / "mlp_fedavgm" / "site-aa68-01_tabnn_fedavgm_20260528_183404",
        "2": FL_RESULTS_ROOT / "mlp_fedavgm" / "site-aa68-02_tabnn_fedavgm_20260528_183404",
        "3": FL_RESULTS_ROOT / "mlp_fedavgm" / "site-aa68-03_tabnn_fedavgm_20260528_183404",
        "4": FL_RESULTS_ROOT / "mlp_fedavgm" / "site-aa68-04_tabnn_fedavgm_20260528_183405",
    },

    server_results_dir=FL_RESULTS_ROOT / "mlp_fedavgm" / "server_run_tabnn_fedavgm_20260528_183403",
