...
``algorithm_name="glm_fedavg"``, the executor uses the Logistic Regression-specific
...
Navigate to the .venv directory of your project, then run in the terminal by:
    ...
    Example:python "C:\\path\\to\\run_lr_fedavg_analysis.py"
"""
import sys
import pandas as pd
...
out = run_analysis(
    ...
    fl_site_results_dirs={
        "1": FL_RESULTS_ROOT / "lr_fedavg" / "site-aa68-01_glm_fedavg_20260601_231324",
        "2": FL_RESULTS_ROOT / "lr_fedavg" / "site-aa68-02_glm_fedavg_20260601_231324",
        "3": FL_RESULTS_ROOT / "lr_fedavg" / "site-aa68-03_glm_fedavg_20260601_231323",
        "4": FL_RESULTS_ROOT / "lr_fedavg" / "site-aa68-04_glm_fedavg_20260601_231322",
    },

    server_results_dir=FL_RESULTS_ROOT / "lr_fedavg" / "server_run_glm_fedavg_20260601_231321",
