...
``algorithm_name="glm_fedavgm"``, the executor uses the Logistic Regression-specific
...
Navigate to the .venv directory of your project, then run in the terminal by:
    ...
    Example:python "C:\\path\\to\\run_lr_fedavgm_analysis.py"
"""
import sys
import pandas as pd
...
out = run_analysis(
    ...
    fl_site_results_dirs={
        "1": FL_RESULTS_ROOT / "lr_fedavgm" / "site-aa68-01_glm_fedavgm_20260603_185217",
        "2": FL_RESULTS_ROOT / "lr_fedavgm" / "site-aa68-02_glm_fedavgm_20260603_185217",
        "3": FL_RESULTS_ROOT / "lr_fedavgm" / "site-aa68-03_glm_fedavgm_20260603_185216",
        "4": FL_RESULTS_ROOT / "lr_fedavgm" / "site-aa68-04_glm_fedavgm_20260603_185217",
    },

    server_results_dir=FL_RESULTS_ROOT / "lr_fedavgm" / "server_run_glm_fedavgm_20260603_185215",
