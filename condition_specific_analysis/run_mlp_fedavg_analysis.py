...
``algorithm_name="tabnn_fedavg"``, the executor uses the MLP-specific
...
Navigate to the .venv directory of your project, then run in the terminal by:
    ...
    Example:python "C:\\path\\to\\run_mlp_fedavg_analysis.py"
"""
import sys
import pandas as pd
...
out = run_analysis(
    ...
    fl_site_results_dirs={
        "1": FL_RESULTS_ROOT / "mlp_fedavg" / "site-aa68-01_tabnn_fedavg_20260528_173729",
        "2": FL_RESULTS_ROOT / "mlp_fedavg" / "site-aa68-02_tabnn_fedavg_20260528_173729",
        "3": FL_RESULTS_ROOT / "mlp_fedavg" / "site-aa68-03_tabnn_fedavg_20260528_173729",
        "4": FL_RESULTS_ROOT / "mlp_fedavg" / "site-aa68-04_tabnn_fedavg_20260528_173729",
    },

    server_results_dir=FL_RESULTS_ROOT / "mlp_fedavg" / "server_run_tabnn_fedavg_20260528_173727",
